...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your Robot for PIAIC...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: "0x833A21B0ef9767Ff7DD58B8c904fA6409FFF0016",
      ...
      .then((receipt) => {
        setFeedback(
          "WOW, you now own a Robot. go visit testnets.opensea.io to view it."
        );
        setClaimingNft(false);
      ...
      {blockchain.account === "" || blockchain.smartContract === null ? (
        <s.Container flex={1} ai={"center"} jc={"center"}>
          ...
          <s.TextTitle style={{ textAlign: "center" }}>
            Mint a ROBOTS_OF_PIAIC
          </s.TextTitle>
          <s.SpacerSmall />
          <s.TextDescription style={{ textAlign: "center" }}>
            Connect to the Ethereum Rinkybe network
          </s.TextDescription>
          <s.SpacerSmall />
          <StyledButton
            onClick={(e) => {
          ...
          <s.Container flex={1} ai={"center"} jc={"center"}>
            ...
            {Number(data.totalSupply) == 100 ? (
              <>
                ...
                <s.SpacerSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find ROBOTS_OF_PIAIC on{" "}
                  <a
                    target={"_blank"}
                    href={"https://testnets.opensea.io/collection/robots-of-piaic"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
              ...
              <>
                <s.TextTitle style={{ textAlign: "center" }}>
                  1 ROBOT costs {data.cost / 1e18} ETH.
                </s.TextTitle>
                <s.SpacerXSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  Excluding gas fee.
                ...
                >
                  ...
                  >
                    ...
                    (Ethereum Rinkybe) and the correct address. Please note:
